      ...
      .on ("message", function (message, rinfo){
        ...
        if (op === opcodes.RRQ){
          ...
          var gs = new GetStream (me, helper, message, options, function (file){
            ...
            //Call the request listener
            me.emit ("request", gs, new PutStream ());
          });
        }else{
...
Server.prototype.listen = function (){
  var me = this;
  this._socket.bind (this.port, this.hostname, function (){
    me.hostname = me._socket.address ().address;
    me.emit ("listening");
  });
};
