...
module.exports = function (opts, server){
	...
	var windowSize = sanitizeNumber (opts.windowSize || 1);
	...
	// disable these extension by default
	...
	options.extensionsLength = "tsize".length + 2;
	for (var k in options.extensionsString) {
