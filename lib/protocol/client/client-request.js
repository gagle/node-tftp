...
ClientRequest.prototype._onErrorMessage = function (message){
  if (this._oackExpected){
    //Strictly, the error code should be 8 but allowing any error code, the
    //client can handle old servers that send errors when the request message
    //contain extra attributes (the extensions)
