...
ClientRequest.prototype._checkSize = function (blockSize){
  var max = (blockSize || 512)*65535;
  if (this._opOptions.size > max){
...
ClientRequest.prototype._onOackMessage = function (message){
  ...
  }else if (!this._isRRQ && this._checkSize (blockSize)){
...
ClientRequest.prototype._onErrorMessage = function (message){
  if (this._oackExpected && message.code === 8){
    ...
    this._close (new Error (this._prefixError + message.message));
  }
};