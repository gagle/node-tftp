...
var Reader = module.exports = function (remote, globalOptions, getOptions){
  ClientRequest.call (this, opcodes.RRQ, remote, globalOptions, getOptions);
...
util.inherits (Reader, ClientRequest);
...
Reader.prototype._onReady = function (stats, oack){
...
Reader.prototype._notifyWindow = function (block){
  ...
  if (this._lastReceived) return this._close ();
