...
Request.prototype._onOack = function (message){
  ...
  this.emit ("extensions", {
    ...
    rollover: rollover || +this._options.extensions.rollover
  });
...
Request.prototype.sendBlock = function (block, buffer, cb){
  var me = this;
  buffer.__block = true;
...
Request.prototype.sendMessage = function (buffer, cb){//console.log("block: " + buffer.readUInt16BE (2))
  //Apply timeouts and retransmissions
  /*var me = this;
  var id = setTimeout (function (){
    if (buffer.__retries === me._options.retries){
