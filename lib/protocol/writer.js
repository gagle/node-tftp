...
var Writer = module.exports = function (remote, globalOptions, putOptions){
  ...
  this._request = new Request (opcode.WRQ, remote, globalOptions,
      ...
      .on ("extensions", function (extensions){
        me._blockMaker = new BlockMaker (extensions.blockSize, putOptions.size);
        me._window = new Window (extensions.blockSize, extensions.windowSize,
            putOptions.size, me._rollover, this);
...
Writer.prototype._onAck = function (ack){//console.log("ack: " + ack.block)
