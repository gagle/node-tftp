...
var Writer = module.exports = function (remote, globalOptions, size){
  ...
  this._request = new Request (opcode.WRQ, remote, globalOptions, size)
      ...
      .on ("ready", function (stats){
        me._blockMaker = new BlockMaker (stats.blockSize, size);
        me._window = new Window (stats.blockSize, stats.windowSize, size,
            stats.rollover, this);
...
var Window = function (blockSize, windowSize, size, rollover, request){
  ...
  this._sendFn = function (block){
    me._request.sendBlock (block.block, block.data);
  };
  this._retransmitter = request.createRetransmitter ();
