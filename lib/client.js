...
Client.prototype.createGetStream = function (remote){
	this._checkRemote (remote);
	return new GetStream (remote, this._options);
};
...
Client.prototype.get = function (remote, local, cb){
	this._checkRemote (remote);
	...
	var rs = new GetStream (remote, this._options);
	rs
